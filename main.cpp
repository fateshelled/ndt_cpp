...
int main(void){
    ...
    for (size_t i = 0; i < N; ++i) {
        ...
        auto trans_mat1 = ndtcpp::makeTransformationMatrix(1.0f, 0.0f, 0.0f);
        ...
        if (i == N - 1) {
            ...
            ndtcpp::writePointsToSVG(source, ndt_points, "scan_points_ndt.svg", {.ellipse_scale=5.0, .draw_point_covariance = true});
        }
    }
